...
export async function sendReminder(documentId: string, reminderKey?: string) {
  ...
  const renewalGuide = doc.type === 'LICENCIA'
    ? `<div style="margin-top:20px;padding:20px;background:#f7f9fc;border:1px solid #e1e8f0;border-radius:8px"><div style="font:bold 11px Arial,sans-serif;letter-spacing:1px;text-transform:uppercase;color:#2e8f79">Guía de renovación · Licencia</div><ol style="margin:12px 0 0;padding-left:20px;font:14px/22px Arial,sans-serif;color:#4e6682"><li>Ten tu DPI vigente en original y copia.</li><li>Obtén un examen de la vista con clínica óptica u oftalmólogo colegiado activo.</li><li>Lleva tu licencia original y verifica que estés solvente de multas.</li><li>Realiza el pago en una agencia Banrural autorizada y conserva el recibo.</li><li>Preséntate personalmente en una sede de Maycom; consulta si debes programar cita.</li></ol><div style="margin-top:13px;font:13px/20px Arial,sans-serif;color:#4e6682"><strong>Tarifas publicadas:</strong> 1 año Q100 · 2 años Q185 · 3 años Q260 · 4 años Q320 · 5 años Q390.</div><a href="https://www.maycom.com.gt/requisitos" style="display:inline-block;margin-top:14px;color:#2e8f79;font:bold 13px Arial,sans-serif;text-decoration:none">Confirmar requisitos en Maycom →</a></div>`
    : `<div style="margin-top:20px;padding:20px;background:#f7f9fc;border:1px solid #e1e8f0;border-radius:8px"><div style="font:bold 11px Arial,sans-serif;letter-spacing:1px;text-transform:uppercase;color:#2e8f79">Guía de renovación · DPI</div><ol style="margin:12px 0 0;padding-left:20px;font:14px/22px Arial,sans-serif;color:#4e6682"><li>Paga Q100 por la renovación en un banco autorizado y conserva el recibo.</li><li>Acude personalmente a una oficina de RENAP.</li><li>En RENAP actualizarán tus datos, fotografía, huellas y firma.</li><li>Conserva la constancia para consultar y recoger tu nuevo DPI.</li></ol><div style="margin-top:13px;font:13px/20px Arial,sans-serif;color:#4e6682">RENAP informa que el trámite por vencimiento es presencial. Las personas mayores de 70 años tienen DPI con vigencia indefinida.</div><a href="https://www.renap.gob.gt/servicios/requisitos-para-solicitud-de-dpi" style="display:inline-block;margin-top:14px;color:#2e8f79;font:bold 13px Arial,sans-serif;text-decoration:none">Confirmar requisitos en RENAP →</a></div>`;
  const details = `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f7f9fc;border:1px solid #e1e8f0;border-radius:8px"><tr><td style="padding:18px 20px"><div style="font:11px Arial,sans-serif;letter-spacing:1px;text-transform:uppercase;color:#8293a8">Documento</div><div style="margin-top:5px;font:bold 16px Arial,sans-serif;color:#173e69">${escapeHtml(documentType)} · ${documentName}</div></td></tr><tr><td style="padding:0 20px 18px"><div style="font:11px Arial,sans-serif;letter-spacing:1px;text-transform:uppercase;color:#8293a8">Fecha de vencimiento</div><div style="margin-top:5px;font:bold 16px Arial,sans-serif;color:#173e69">${escapeHtml(formattedDate)}</div><div style="margin-top:8px;display:inline-block;padding:5px 9px;border-radius:12px;background:${accent}18;color:${accent};font:bold 12px Arial,sans-serif">${escapeHtml(timing)}</div></td></tr></table>${renewalGuide}<p style="margin:16px 0 0;font:12px/19px Arial,sans-serif;color:#7b8da1">Información verificada en fuentes oficiales en julio de 2026. Los requisitos y tarifas pueden cambiar; confírmalos en el enlace oficial antes de acudir.</p>`;
